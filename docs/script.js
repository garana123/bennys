    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'fib': 'Codewort: Döner mit allem <br> Es wird nicht nach dem Ausweis gefragt! <br> Um die DN festzustellen Frage einfach:"Wie viel Geld hast du dabei?" <br> Alles kostenlos',
            'md': 'Primär: <br> Sekundär: <br> Perlerffekt: <br> Keine Troll Felgen und keine Fenstertönung <br> Dienstfahrzeuge kostenlos',
            'md spezial unit': 'Primär: <br> Sekundär: <br> Perlerffekt: <br> Dienstfahrzeuge kostenlos',
            'pd': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos',
            'tmf': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos',
            'pd cid': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos,', 
            'pd gtf': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos',
            'pd jugular': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos', 
            'pd jugulargtf': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos', 
            'pd s.p.f.u': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos', 
            'pd swat': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos',
            'pd unmarked': 'Primärfarbe:  <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos', 
            'tmf': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Info: Dienstfahrzeuge kostenlos',  
            'tmf unmarked': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br> Dienstfahrzeuge kostenlos',
...
document.getElementById("sendenButton").addEventListener("click", () => {
    ...
    const webhooks = {
        ...
        "mitarbeiter_200.html": "WEBHOOK_200"
        "mitarbeiter_201.html": "WEBHOOK_201"
        "mitarbeiter_202.html": "WEBHOOK_202"
        "mitarbeiter_203.html": "WEBHOOK_203"
        "mitarbeiter_204.html": "WEBHOOK_204"
        "mitarbeiter_205.html": "WEBHOOK_205"
        "mitarbeiter_206.html": "WEBHOOK_206"
        "mitarbeiter_207.html": "WEBHOOK_207"
        "mitarbeiter_208.html": "WEBHOOK_208"
        "mitarbeiter_209.html": "WEBHOOK_209"
        "mitarbeiter_210.html": "WEBHOOK_210"
        "mitarbeiter_211.html": "WEBHOOK_211"
        "mitarbeiter_212.html": "WEBHOOK_212"
