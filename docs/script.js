    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'md': 'Primär: <br> Sekundär: <br> Perlerffekt: <br> Keine Troll Felgen und keine Fenstertönung <br>',
            'md spezial unit': 'Primär: <br> Sekundär: <br> Perlerffekt: <br>',
            'pd': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br>',
            'tmf': 'Primärfarbe: <br> Sekundärfarbe: <br> Perleffekt: <br>',
