document.addEventListener('DOMContentLoaded', () => {
    ...
    if (zuordnungSelectElement) {
        ...
        const optionInfo = {
            ...
            'sd vip': 'Primärfarbe: Gebürstetes Aluminium (chrome) <br> Sekundärfarbe: Alabster Weiß <br> Perleffekt: Creme(Weiss) <br> Info: Die Ränge Cadet, Junior Deputy und Deputy tunen Dienstfahrzeuge kostenlos',
            ...
            'azalea syndikat vip': 'Primärfarbe: Zuckerpflaume (Rosa) <br> Sekundärfarbe: Zuckerpflaume (Rosa) <br> Perleffekt: Kaugummiblau <br> Reifenqualm: ./. <br> Info: ./.',
            'azalea syndikat ug vip': 'Primärfarbe: Weinrot <br> Sekundärfarbe: ./. <br> Perleffekt: Cremeweiß <br> Reifenqualm: ./. <br> Info: ./.',
            ...
            'pe$o vip': 'Primärfarbe: #797582 <br> Sekundärfarbe: #797582 <br> Perleffekt: Schwarz (Nichts) <br> Reifenqualm: ./.',
            'pe$o ug vip': 'Primärfarbe: #260000 <br> Sekundärfarbe: ./. <br> Perleffekt: SchwarzR <br> eifenqualm: ./.',
            'rezero vip': 'Primärfarbe: Mystisches Lila <br> Sekundärfarbe: ./. <br> Perleffekt: Lila Metallic <br> Reifenqualm: ./.',
            'rezeroug vip': 'Primärfarbe: Matt Schwarz <br> Sekundärfarbe: Matt Schwarz <br> Perleffekt: Dunkles Rot <br> Reifenqualm: /', 
            ...
            'blancos': 'Primärfarbe: Chrom <br> Sekundärfarbe: Chrom <br> Perleffekt: Kaugummi Blau <br> Unterboden: Light Blue <br> Headlights: Hellblau', 
            ...
            'angels of death mc': 'Primärfarbe: Carbenat Rot <br> Sekundärfarbe: Carbenat Rot <br> Perleffekt: Dunkelblau <br> Reifenqualm: ./. <br> Unterboden: ./.', 
            'outlaw mc': 'Primärfarbe: Matt Weiß <br> Sekundärfarbe: Matt Weiß <br> Perleffekt: Torino Rot <br> Reifenqualm: ./. <br> Unterboden: ./.', 
            'hellborn mc': '', 
            'mg13': 'Primärfarbe: Kaugummi Blau <br> Sekundärfarbe: Kaugummi Blau <br> Perleffekt: Helles Gold <br> Reifenqualm: ./. <br> Unterboden: ./.', 
